  ...
  var interpolate = g.Interpolate = {},
    ...
    translate = interpolate.translate = function (a,b,u,v){
      ...
      for (var ax in b){
        ...
        translation[ax] = ( a[ax]===b[ax] ? b[ax] : ~~(a[ax] + ( b[ax] - a[ax] ) * v ) ) + u;
      }
    ...
    perspective = function () {
      ...
      if ( ops.transformOrigin !== undefined ) { el.style[property('transformOrigin')] = ops.transformOrigin; } // element transform origin
